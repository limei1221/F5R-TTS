...
if __name__ == "__main__":
    ...
    dataset_dir = "/Volumes/Element2/TTS_data/LibriTTS_Data/LibriTTS"
    ...
    # For LibriTTS_100_char, sample count: 33188
    # For LibriTTS_100_char, vocab size is: 70
    # For LibriTTS_100_char, total 53.69 hours
